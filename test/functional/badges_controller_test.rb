...
class BadgesControllerTest < ActionController::TestCase
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post :create, badge: { Description: @badge.Description, badgeID: @badge.badgeID, badgeName: @badge.badgeName }
    end
  ...
  test "should update badge" do
    put :update, id: @badge, badge: { Description: @badge.Description, badgeID: @badge.badgeID, badgeName: @badge.badgeName }
    assert_redirected_to badge_path(assigns(:badge))
  end
